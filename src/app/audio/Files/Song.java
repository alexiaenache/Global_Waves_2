...
public final class Song extends AudioFile {
    ...
    public Song(final String name, final Integer duration,
                final String album, final ArrayList<String> tags, final String lyrics,
...
/**
 * Increases the number of likes for the song.
 */
    public void like() {
        likes++;
    }
...
/**
 * Decreases the number of likes for the song.
 */
    public void dislike() {
        likes--;
    }
